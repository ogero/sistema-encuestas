...
|
*/
$config['collections']['users']          = 'Usuarios';
$config['collections']['groups']         = 'Grupos';
 ...
 */
$config['email_activate'] = 'activar.tpl.php';
 ...
 */
$config['email_forgot_password'] = 'olvido_contrasena.tpl.php';
